 ...
 * documents distincts, servis par deux endpoints. Les fondre en une liste
 * laisserait croire qu'un même fichier porte des colis et un type de
 * réclamation.
 *
            ...
            >
                <span className="min-w-0">
                    <span className="text-sm font-medium">
                        {t("integrations.imports.reference.title")}
                    </span>
                    ...
                    {IMPORT_TARGETS.map((target) => (
                        ...
                        >
                            <p className="border-b pb-1.5 text-sm font-medium">
                                {t(
                                    `integrations.imports.reference.targets.${target.key}`,
                                )}
                            </p>
                            ...
                            {target.groups.map((group) => (
                                <div key={group.key}>
                                    <p className="mb-2 text-xs font-medium uppercase text-muted-foreground">
                                        {t(
                                            `integrations.imports.reference.groups.${group.key}`,
                                        )}
                                    </p>
                                        ...
                                        {group.fields.map((field) => (
                                            ...
                                            >
                                                <Button
                                                    ...
                                                    aria-label={t(
                                                        "integrations.imports.reference.copyField",
                                                        {
                                                            field: field.path,
                                                        },
                                                    )}
                                                ...
                                                "optional" ? null : (
                                                    ...
                                                    >
                                                        {t(
                                                            `integrations.imports.reference.rules.${field.ruleKey}`,
                                                        )}
                                                    </Badge>
                                                )}
