 ...
 */
class UpdateOrganizationApiConfigurationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'baseUrl' => ['sometimes', 'url:https', 'max:512'],
            'authType' => ['sometimes', Rule::in(['none', 'bearer', 'api_key', 'basic'])],
