...
import { statusColumns } from '../pages/statusColumns'
...
/**
 * Le référentiel lui-même : le libellé, l'icône et le rang de chaque code.
 *
 * C'est le premier onglet de l'écran des statuts — les deux autres règlent ce
 * que ces statuts **font** : celui qu'une entité reçoit en naissant, et ce que
 * chacun entraîne sur ses voisins.
 */
export function StatusReferentialPanel() {
