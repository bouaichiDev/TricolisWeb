...
export function ImportTargetFieldsReference({ onInsert }: ImportTargetFieldsReferenceProps) {
  ...
  // Ouvert d'emblée : le panneau occupe sa propre colonne, à côté du JSON.
  // Replié, il laisserait une colonne vide et obligerait à un clic de plus.
    ...
    <div className="rounded-lg border bg-muted/30">
      ...
      {open ? (
        <div className="flex flex-col gap-3 border-t px-4 py-4">
          ...
          {/* Seule la liste défile : l'avertissement du bas doit rester lu. */}
